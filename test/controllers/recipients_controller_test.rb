...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { is_deleted: @recipient.is_deleted, is_read: @recipient.is_read, message_id: @recipient.message_id, user_id: @recipient.user_id }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { is_deleted: @recipient.is_deleted, is_read: @recipient.is_read, message_id: @recipient.message_id, user_id: @recipient.user_id }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
